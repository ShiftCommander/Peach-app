...
test('manifest and HTML expose the correct platform icon roles', () => {
  ...
  assert.equal(byKey.get('maskable:192x192'), 'icons/maskable-icon-192.png?v=52.2.1');
  assert.equal(byKey.get('maskable:512x512'), 'icons/maskable-icon-512.png?v=52.2.1');
